...
@testset "eQuilibrator tests" begin
    ...
    @testset "utils" begin
        ...
        @test bigg(r_str) == "bigg.metabolite:atp + bigg.metabolite:h2o = bigg.metabolite:adp + bigg.metabolite:pi"
        @test kegg(r_str) == "kegg:atp + kegg:h2o = kegg:adp + kegg:pi"
        @test metanetx(r_str) == "metanetx.chemical:atp + metanetx.chemical:h2o = metanetx.chemical:adp + metanetx.chemical:pi"
    ...
    @testset "univariate_reaction" begin
        ...
        ΔGprime = ustrip(u"kJ/mol", dg_prime(eq, bigg(r_str); concentrations=concentrations))
